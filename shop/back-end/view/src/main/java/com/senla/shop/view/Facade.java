...
public class Facade implements IFacade {
    ...
    private Facade(){
        ...
        auditManager = (IAuditManager) DependencyInjection.getInstance().getObject(IAuditManager.class);
    }
    ...
    @Override
    public synchronized void addAudit(Audit audit){
        try {
            auditManager.create(audit);
        } catch (Exception e){
            LOGGER.error("Creation of audit is failed", e);
        }
    }
